...
import com.naviera.api.service.OpEncomendaService;
import com.naviera.api.service.OpEncomendaWriteService;
...
@RestController
@RequestMapping("/op/encomendas")
public class OpEncomendaController {
    private final OpEncomendaService service;
    private final OpEncomendaWriteService writeService;

    public OpEncomendaController(OpEncomendaService service, OpEncomendaWriteService writeService) {
